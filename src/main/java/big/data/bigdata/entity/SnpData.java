...
public class SnpData {
    ...
    public void setRefAlleleFrequency(Float refAlleleFrequency) {
        this.refAlleleFrequency = refAlleleFrequency;
    }
    ...
    public void setAltAlleleFrequency(Float altAlleleFrequency) {
    ...
    public Integer getAlleleCount() {return alleleCount;}

    public void setAlleleCount(Integer alleleCount) {this.alleleCount = alleleCount;}
}
